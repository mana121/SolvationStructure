...
├── simulation
    ├── electrolyte               
         ...
         ├── LAMMPS               <- LAMMPS input files for energy minimization, equilibration, and production run
    ├── solvation structure       <- CONTCAR and INCAR files for DFT in VASP
