...
[![fftool Version](https://img.shields.io/badge/fftool-Version%202024%2F01%2F18-green)](https://github.com/paduagroup/fftool)
...
```bash
@article{hasan2025computational,
  ...
  author={Hasan, Rumana and Datta, Dibakar},
  journal={arXiv preprint arXiv:2501.11932},
  year={2025}
}
```
